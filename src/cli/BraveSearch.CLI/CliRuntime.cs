...
internal static class CliRuntime
{
    ...
    public static async Task<global::BraveSearch.BraveSearchClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::BraveSearch.ApiException exception)
    {
        var builder = new StringBuilder();
