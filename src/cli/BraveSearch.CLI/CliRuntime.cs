...
namespace BraveSearch.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "BraveSearch.CLI";
    private const string UserSecretApiKeyName = "BRAVESEARCH_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"BRAVESEARCH_API_KEY"];
    private const string CredentialFileDirectoryName = ".brave-search";

    public static async global::System.Threading.Tasks.Task<global::BraveSearch.BraveSearchClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::BraveSearch.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::BraveSearch.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::BraveSearch.BraveSearchClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::BraveSearch.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::BraveSearch.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::BraveSearch.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::BraveSearch.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("BRAVESEARCH_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::BraveSearch.ApiException exception)
    {
        var builder = new StringBuilder();
