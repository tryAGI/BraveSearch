...
namespace BraveSearch
{
    ...
    public sealed partial class ImageSearchResponse
    {
        ...
        public global::System.Collections.Generic.IList<global::BraveSearch.ImageResult>? Results { get; set; }
        ...
        public ImageSearchResponse(
            ...
            global::System.Collections.Generic.IList<global::BraveSearch.ImageResult>? results)
        {
            this.Type = type;
            this.Query = query;
