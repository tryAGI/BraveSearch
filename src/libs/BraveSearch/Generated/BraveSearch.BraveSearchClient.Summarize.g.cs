...
namespace BraveSearch
{
    public partial class BraveSearchClient
    {
        ...
        private static readonly global::BraveSearch.EndPointSecurityRequirement s_SummarizeSecurityRequirement0 =
        ...
        private static readonly global::BraveSearch.EndPointSecurityRequirement[] s_SummarizeSecurityRequirements =
            new global::BraveSearch.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::BraveSearch.SummarizerSearchResult> SummarizeAsync(
            string key,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::BraveSearch.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::BraveSearch.AutoSDKHttpResponse<global::BraveSearch.SummarizerSearchResult>> SummarizeAsResponseAsync(
            string key,
            bool? entityInfo = default,
            global::BraveSearch.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                else
                {
                    await global::BraveSearch.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw global::BraveSearch.ApiException<global::BraveSearch.ErrorResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                global::BraveSearch.ErrorResponse? __value_422 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_422 = global::BraveSearch.ErrorResponse.FromJson(__content_422, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::BraveSearch.SummarizerSearchResult.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::BraveSearch.AutoSDKHttpResponse<global::BraveSearch.SummarizerSearchResult>(
                                        statusCode: __response.StatusCode,
                                ...
                                {
                                    throw global::BraveSearch.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::BraveSearch.SummarizerSearchResult.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
