...
namespace BraveSearch
{
    ...
    public sealed partial class NewsSearchResponse
    {
        ...
        public global::System.Collections.Generic.IList<global::BraveSearch.NewsResult>? Results { get; set; }
        ...
        public NewsSearchResponse(
            ...
            global::System.Collections.Generic.IList<global::BraveSearch.NewsResult>? results)
        {
            this.Type = type;
            this.Query = query;
