...
namespace BraveSearch
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::BraveSearch.AutoSDKRetryOptions Retry { get; set; } = new global::BraveSearch.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::BraveSearch.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::BraveSearch.IAutoSDKHook>();
        ...
        public global::BraveSearch.AutoSDKClientOptions AddHook(
            global::BraveSearch.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::BraveSearch.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::BraveSearch.AutoSDKClientOptions UseAuthorizationProvider(
            global::BraveSearch.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::BraveSearch.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::BraveSearch.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::BraveSearch.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::BraveSearch.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::BraveSearch.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::BraveSearch.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::BraveSearch.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::BraveSearch.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::BraveSearch.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::BraveSearch.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::BraveSearch.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::BraveSearch.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::BraveSearch.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::BraveSearch.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::BraveSearch.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::BraveSearch.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::BraveSearch.AutoSDKClientOptions clientOptions,
            global::BraveSearch.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::BraveSearch.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::BraveSearch.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::BraveSearch.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::BraveSearch.AutoSDKClientOptions clientOptions,
            global::System.Func<global::BraveSearch.IAutoSDKHook, global::BraveSearch.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::BraveSearch.AutoSDKHookContext context)
        {
